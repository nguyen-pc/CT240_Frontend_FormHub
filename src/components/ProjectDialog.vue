        ...
        <DialogContent>
            ...
            <form @submit.prevent="handleSubmit">
                <div>
                    ...
                    <input v-model="newData" id="name" :placeholder="'Nhập ' + title" class="input-field" />
                    <input v-model="newDescription" id="description" :placeholder="'Nhập mô tả ' + title" class="input-field" />
                </div>
...
watch(() => dialogStore.isOpen, (newVal) => {
    isOpen.value = newVal;
